...
\begin{definition}[absorbant, barrelled]
    $E$を線型空間とする．
    \begin{enumerate}
        \item $M\subset E$が\textbf{吸収元}であるとは，$\cup_{t>0}tM=E$を満たすことをいう．
        \item 任意の閉じた絶対凸な吸収的集合（これを\textbf{樽}という）が，$0$の近傍であるとき，局所凸線型空間$E$を\textbf{樽的}であるという．
    \end{enumerate}
\end{definition}
