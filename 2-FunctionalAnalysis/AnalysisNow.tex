...
\begin{example}[Hilbert-Schmidt]\label{exp-Hilbert-Schmidt}
    積分核が2乗可積分である$k\in L^2(\Om\times\Om;\C)$とき，この積分作用素を\textbf{Hilbert-Schmidt作用素}といい，コンパクト作用素になる\ref{def-trace-class-Hilbert-Schmidt}．
...
\begin{proposition}\mbox{}
    \begin{enumerate}
        ...
        \item 対応$T:L^2(X^2)\to B^2(L^2(X));k\mapsto T_k$は，$B^2(L^2(X))$上の2-ノルムについて等長同型になる．
...
\subsection{Strum-Liouville作用素への応用}
