...
\begin{quotation}
    ...
    これを修正するのがStratonovich積分／対称確率積分であるが，$X$に対してより強い条件を必要とすることとなる．
    ...
    ここでBrown運動と言っていたものは，一般のマルチンゲールで良い．
    これはDoobが初めに指摘し，渡辺信三，国田寛 (67,\cite{KunitaWatanabe})が理論を作り，変数変換公式を得た．
