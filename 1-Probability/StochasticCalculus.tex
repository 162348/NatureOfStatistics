...
\begin{proof}\mbox{}
    \begin{enumerate}
        ...
        あとは，$\om:\R_+\to\R$が平均$0$，共分散$\min$のGauss過程であることを示せば良いが，$\om\sim N(0,s)$に注意すると，$E[\om(s)]=0$．
...
\begin{definition}[natural filtration]
    ...
    \begin{enumerate}
        \item $\F_t\subset\F\;(t\in\R_+)$を，確率変数族$\{B_s\}_{s\in[0,t]}$と零集合$\cN(P)$が生成する完備な$\sigma$-加法族とする．
