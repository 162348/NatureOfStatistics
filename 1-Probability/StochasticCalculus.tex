...
\begin{definition}[Wiener integral]
    $\varphi\in\E_0$上の有界線型作用素$\E_0\to L^2(\Om)$
...
\begin{definition}[white noise]
    ...
    この族$W:\D\ni A\mapsto W(A)$は，線型な等長写像$L^2(D)\ni\varphi\mapsto\int_D\varphi(x)W(dx)\in\o{W}$に延長出来る．
    ただし，$\o{W}$は$W=\{W(A)\}_{A\in\D}$が生成するGauss部分空間とした．
\end{definition}
